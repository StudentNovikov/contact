...
public final class ConsoleMessages {
    ...
    public static final String CONTACT_MENU = "Choose one of the following:" + "\n" +
    ...
    public static final String MAIN_MENU = "Choose what do you want to work with:" + "\n" +
            " 1. Contacts" + "\n" +
            " 2. Groups" + "\n" +
            " 3. Exit";

    public static final String GROUP_MENU = "Choose one of the following:" + "\n" +
            " 1. Show all groups " + "\n" +
    ...
    public static final String FINISHED = "Thanks for using our app";
